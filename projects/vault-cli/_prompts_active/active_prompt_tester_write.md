...
3. 按 `_shared/doc_templates/test_plan.md` 格式设计测试用例矩阵（覆盖正常流、异常流、边界值、加密/解密往返验证、口令错误、文件不存在等），写入 `04_testing/test_cases.md`。
4. 使用 pytest 框架编写自动化测试脚本代码，存入 04_testing/test_scripts。
